    ...
    constructor(logoUrl){
        ...
        <div class = "${styles.footer} ${styles["max-width-wrapper"]}">
            ...
            <div class = "${styles["footer-content"]}">
                <div class = "${styles["column-content"]} ${styles.about}">
                    <div class = "${styles["column-header"]}">
                        ABOUT ZOMATO
                    </div>
                    <div class = "${styles["column-body"]} ">
                        <div>Who We Are</div>
                        <div>Blog</div>
                ...
                <div class = "${styles["column-content"]} ${styles.zomaverse}">
                    <div class = "${styles["column-header"]}">
                        ZOMAVERSE
                    </div>
                    <div class = "${styles["column-body"]}">
                ...
                <div class = "${styles["column-content"]} ${styles.restaurants}">
                    <div class = "${styles["column-header"]}">
                        FOR RESTAURANTS
                    </div>
                    <div class = "${styles["column-body"]}">
                ...
                <div class = "${styles["column-content"]} ${styles.enterprises}">
                    <div class = "${styles["column-header"]}">
                        FOR ENTERPRISES
                    </div>
                    <div class = "${styles["column-body"]}">
                ...
                <div class = "${styles["column-content"]} ${styles.learn}">
                    <div class = "${styles["column-header"]}">
                        LEARN MORE
                    </div>
                    <div class = "${styles["column-body"]}">
                ...
                <div class = "${styles["column-content"]} ${styles.social}">
                    <div class = "${styles["column-header"]}">
                        SOCIAL LINKS
                    </div>
                    <div class = "${styles["social-body"]}">
                        ...
                        <div class  = "${styles["app-icon-wrapper"]}">
                            <img alt="image" src="https://b.zmtcdn.com/data/webuikit/9f0c85a5e33adb783fa0aef667075f9e1556003622.png" class = "${styles["app-icon"]}">
                            <img alt="image" src="https://b.zmtcdn.com/data/webuikit/23e930757c3df49840c482a8638bf5c31556001144.png" class = "${styles["app-icon"]}">
                        </div>
                    </div>
                </div>
            </div>
